...
const contractAddress = '0x825E60996Cd8Ee5Bb175d6ccF7Abc1a9c381D359';

const metaAccount = document.getElementById('metaAccount').innerHTML;
const ipfsfilelink = document.getElementById('ipfsfilelink').innerHTML;
const ipfsdatalink = document.getElementById('ipfsdatalink').innerHTML;
...
saveToBlockchain.addEventListener('click', async(e) => {
    ...
    await window.contract.methods.add(metaAccount, ipfsfilelink).send({from: metaAccount});
